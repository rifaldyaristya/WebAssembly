...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_multiplyMatrix')) {
        Object.defineProperty(Module['ready'], '_multiplyMatrix', { configurable: true, get: function() { abort('You are getting _multiplyMatrix on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_multiplyMatrix', { configurable: true, set: function() { abort('You are setting _multiplyMatrix on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'multiplyMatrix.wasm';
...
/** @type {function(...*):?} */
var _multiplyMatrix = Module["_multiplyMatrix"] = createExportWrapper("multiplyMatrix");
